...
class Payment(models.Model):
    ...
    stripe_link = models.URLField(max_length=400, verbose_name='ссылка для платежа', **NULLABLE)
    stripe_id = models.CharField(max_length=255, verbose_name='id платежа', **NULLABLE)
